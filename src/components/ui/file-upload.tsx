...
const FileUploadItem = React.forwardRef<HTMLLIElement, FileUploadItemProps>(function FileUploadItem(props, ref) {
	...
	return (
		<ChakraFileUpload.Item file={file} ref={ref} bg={"bg.success"} borderColor={"border.success"}>
			<ChakraFileUpload.ItemPreview asChild>
				<Icon fontSize='lg' color='fg.success'>
					<LuFile />
				</Icon>
			...
			{showSize ? (
				...
				<ChakraFileUpload.ItemName flex='1' color='fg.success' />
			)}

			{clearable && (
				<ChakraFileUpload.ItemDeleteTrigger asChild>
					<IconButton variant='ghost' color='fg.success' size='xs'>
						<LuX />
					</IconButton>
